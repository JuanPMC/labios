 ...
 ******************************************************************************/
#ifndef LABIOS_MAIN_TASKESTIMATORHOMOGENEUS_SOLVER_H
#define LABIOS_MAIN_TASKESTIMATORHOMOGENEUS_SOLVER_H
/******************************************************************************
 *include files
 ******************************************************************************/
 ...
 *Class
 ******************************************************************************/
class taskEstimatorHomogeneus_solver : public solver {
private:
  /******************************************************************************
...
public:
   ...
   *Interface
   ******************************************************************************/
  inline static std::shared_ptr<taskEstimatorHomogeneus_solver>
  getInstance(service service) {
    return instance == nullptr ? instance = std::shared_ptr<taskEstimatorHomogeneus_solver>(
...
#endif // LABIOS_MAIN_TASKESTIMATORHOMOGENEUS_SOLVER_H
